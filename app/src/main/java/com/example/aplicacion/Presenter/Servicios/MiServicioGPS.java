...
public class MiServicioGPS extends Service implements LocationListener {
    ...
    public MiServicioGPS(Context contex, GoogleMap mMap) {
        super();
        this.contex = contex;
        this.mMap = mMap;
    ...
    public void getLocation() {
        try {
            ...
            locationManager.requestLocationUpdates(locationManager.GPS_PROVIDER
                    , 1000 * 10
                    , 10, this);//peticion al servicio para obtener actualizaciones del gps cada cierto tiempo
            MapsFragment.location  =  locationManager.getLastKnownLocation(locationManager.GPS_PROVIDER);
            latitud =  MapsFragment.location.getLatitude();
            longitud = MapsFragment.location.getLongitude();
            Toast.makeText(contex, "Ingreso", Toast.LENGTH_LONG ).show();
    ...
    public void onLocationChanged(@NonNull Location location) {
        //texto.setText("Coordenadas: "+location.getLatitude() + " / "+ location.getLongitude());
        Toast.makeText(contex, "Coordenadas: "+location.getLatitude() + " / "+ location.getLatitude()+ "**"+ ++i, Toast.LENGTH_LONG ).show();
        ...
        //webServiceObtenerRuta(String.valueOf(latinicial), String.valueOf(longinicial),String.valueOf(location.getLatitude()),String.valueOf(location.getLongitude()));
        //draw();
    }
